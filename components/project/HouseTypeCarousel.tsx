// components/HouseTypesCarouselClient.tsx
"use client";
...
export default function HouseTypesCarousel({ projects }: Props) {
          ...
          >
            ...
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-20
                w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg border border-black
...
function HouseCard({
  ...
  return (
    <Link href={`/projects/${slug}`} className="block group">
      <div className="relative h-120 md:h-125 rounded-[10px] overflow-hidden cursor-pointer">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
          ...
          <div className="flex items-center gap-2 text-white font-semibold text-sm md:text-[16px] font-inter">
            View Project
